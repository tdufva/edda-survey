    ...
    <main>
      <header className="site-header">
        ...
        <nav aria-label="Page sections">
          ...
          <Link href="/responses/">All responses</Link><Link href="/areas/">AREAS</Link><Link href="/dator/">Dator</Link><Link href="/comparison/">Comparison</Link><Link href="/sorting/">Dator sorting</Link><Link href="/areas-sorting/">AREAS sorting</Link>
        </nav>
      </header>
